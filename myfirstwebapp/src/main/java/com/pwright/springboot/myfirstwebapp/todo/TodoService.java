...
public class TodoService {
	...
	static {
		todos.add(new Todo(++todosCount, "Patrick", "Get AWS Certified", LocalDate.now().plusYears(1), false));
		todos.add(new Todo(++todosCount, "Patrick", "Learn DevOps", LocalDate.now().plusYears(2), false));
		todos.add(
				new Todo(++todosCount, "Patrick", "Learn Full Stack Development", LocalDate.now().plusYears(3), false));
	}
